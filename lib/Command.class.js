    ...
    this.options.forEach(option => {
      switch (true) {
        case option instanceof SlashCommandAttachmentOption:
          this._def.addAttachmentOption(option);
          break;
        case option instanceof SlashCommandBooleanOption:
          this._def.addBooleanOption(option);
          break;
        case option instanceof SlashCommandChannelOption:
          this._def.addChannelOption(option);
          break;
        case option instanceof SlashCommandIntegerOption:
          this._def.addIntegerOption(option);
          break;
        case option instanceof SlashCommandNumberOption:
          this._def.addNumberOption(option);
          break;
        case option instanceof SlashCommandMentionableOption:
          this._def.addMentionableOption(option);
          break;
        ...
        case option instanceof SlashCommandUserOption:
          this._def.addUserOption(option);
          break;
        case option instanceof SlashCommandRoleOption:
          this._def.addRoleOption(option);
          break;
        default:
